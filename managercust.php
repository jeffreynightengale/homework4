...
<?php
    $section_sql = "select customer_name from Customer c join Employee e on e.employee_id = c.employee_id join Manager m on e.manager_id = m.manager_id where m.manager_id=" . $row["manager_id"];
